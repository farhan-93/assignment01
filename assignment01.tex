...
\begin{figure}
\includegraphics[width=\linewidth]{fig/createrepository.PNG}
...
\begin{figure}
\includegraphics[width=\linewidth]{fig/createfile.PNG}
\caption{Create file}
\label{cfile}
\end{figure}
...
\begin{figure}
\includegraphics[width=\linewidth]{fig/Commit.PNG}
